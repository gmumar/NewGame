...
public class PopQueObject {
	...
	public PopQueObject(PopQueObjectType userError, String header,
		...
		if (!(userError == PopQueObjectType.ERROR_PARTS_NOT_UNLOCKED
				...
				|| userError == PopQueObjectType.ERROR_USER_NAME_ENTRY))
			return;
