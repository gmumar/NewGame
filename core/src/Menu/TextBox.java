...
public class TextBox extends TextField {
	...
	public TextBox(String name, Skin skin, String style) {
		super(name, skin, style);
	}
	...
	private static Skin defaultSkin() {
		Skin skin = new Skin();
		BitmapFont bfont = FontManager.GenerateScaledFont(
				"fonts/simpleFont.ttf", 4, Color.GREEN, 10, 1);
		skin.add("font", bfont);
		return skin;
	}
